    ...
    <div className="mx-auto max-w-6xl space-y-16 px-4 py-16 sm:px-6">
      ...
      <div className="grid gap-10 lg:grid-cols-[1.2fr_1fr]">
        <div className="space-y-6 text-sm text-slate-200">
          <p>
            Naše bowlingové centrum je navrženo pro hráče všech úrovní. Díky inteligentnímu scoringu a LED efektnímu osvětlení
            si užijete každé roztočení koule.
          </p>
          ...
          <div className="rounded-3xl border border-brand/40 bg-brand/10 p-6 text-brand-light">
            ...
            <p className="mt-3 text-slate-100">
              Zavolejte na +420 000 000 000 nebo napište na <a href="mailto:bowling@u-fandy.cz" className="underline">bowling@u-fandy.cz</a>.
            </p>
          </div>
        </div>
